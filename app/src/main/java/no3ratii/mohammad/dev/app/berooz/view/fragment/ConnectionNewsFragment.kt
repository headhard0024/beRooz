...
import no3ratii.mohammad.dev.app.berooz.viewmodel.FragmentConnectionNewsViewModel

class ConnectionNewsFragment : Fragment() {

    private lateinit var connectionNewViewModel: FragmentConnectionNewsViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        connectionNewViewModel = FragmentConnectionNewsViewModel(requireActivity())
    ...
    private fun setAdapterItems() {
        connectionNewViewModel.images.observe(viewLifecycleOwner, Observer { images ->
            connectionNewViewModel.itemList.observe(viewLifecycleOwner, Observer {
