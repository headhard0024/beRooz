...
import no3ratii.mohammad.dev.app.berooz.viewmodel.FragmentICTNewsViewModel

class ICTNewsFragment : Fragment() {

    private lateinit var ictNewViewModel: FragmentICTNewsViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        ictNewViewModel = FragmentICTNewsViewModel(requireActivity())
    ...
    private fun setAdapterItems() {
        ictNewViewModel.images.observe(viewLifecycleOwner, Observer { images ->
            ictNewViewModel.itemList.observe(viewLifecycleOwner, Observer {
