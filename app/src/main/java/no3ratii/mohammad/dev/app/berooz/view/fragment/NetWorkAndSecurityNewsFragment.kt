...
import no3ratii.mohammad.dev.app.berooz.viewmodel.FragmentNetWorkAndSecurityNewsViewModel

class NetWorkAndSecurityNewsFragment : Fragment() {

    private lateinit var netWorkAndSecurityNewViewModel: FragmentNetWorkAndSecurityNewsViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        netWorkAndSecurityNewViewModel = FragmentNetWorkAndSecurityNewsViewModel(requireActivity())
    ...
    private fun setAdapterItems() {
        netWorkAndSecurityNewViewModel.images.observe(viewLifecycleOwner, Observer { images ->
            netWorkAndSecurityNewViewModel.itemList.observe(viewLifecycleOwner, Observer {
