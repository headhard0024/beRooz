...
import no3ratii.mohammad.dev.app.berooz.viewmodel.FragmentSpaceNewsViewModel

class SpaceNewsFragment : Fragment() {

    private lateinit var spaceNewViewModel: FragmentSpaceNewsViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        spaceNewViewModel = FragmentSpaceNewsViewModel(requireActivity())
    ...
    private fun setAdapterItems() {
        spaceNewViewModel.images.observe(viewLifecycleOwner, Observer { images ->
            spaceNewViewModel.itemList.observe(viewLifecycleOwner, Observer {
