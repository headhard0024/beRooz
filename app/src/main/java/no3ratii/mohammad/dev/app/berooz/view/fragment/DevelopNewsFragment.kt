...
import no3ratii.mohammad.dev.app.berooz.viewmodel.FragmentDevelpeNewsViewModel

class DevelopNewsFragment : Fragment() {

    private lateinit var developNewViewModel: FragmentDevelpeNewsViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        developNewViewModel = FragmentDevelpeNewsViewModel(requireActivity())
    ...
    private fun setAdapterItems() {
        developNewViewModel.images.observe(viewLifecycleOwner, Observer { images ->
            developNewViewModel.itemList.observe(viewLifecycleOwner, Observer {
