...
class MoblieNewsFragment : Fragment() {

    private lateinit var moblieNewViewModel: FragmentMoblieNewsViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        moblieNewViewModel = FragmentMoblieNewsViewModel(requireActivity())
    ...
    private fun setAdapterItems() {
        moblieNewViewModel.images.observe(viewLifecycleOwner, Observer { images ->
            moblieNewViewModel.itemList.observe(viewLifecycleOwner, Observer {
