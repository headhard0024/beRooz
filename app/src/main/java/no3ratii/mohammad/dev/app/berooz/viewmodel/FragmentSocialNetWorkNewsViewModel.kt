...
class FragmentSocialNetWorkNewsViewModel(activity: Activity) {
    ...
    private fun initialize(activity: Activity) {
        object : AReadNews() {
            override fun onSuccess(
                ...
                this@FragmentSocialNetWorkNewsViewModel.itemList.value = itemList
                this@FragmentSocialNetWorkNewsViewModel.images.value = images
            }
        }.read(activity , " https://www.itna.ir/rssdx.gmyefy,ggeltshmci.2yy2..sj6avafy3v.xml")
