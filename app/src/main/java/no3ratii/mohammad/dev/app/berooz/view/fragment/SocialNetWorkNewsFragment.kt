...
import no3ratii.mohammad.dev.app.berooz.viewmodel.FragmentSocialNetWorkNewsViewModel

class SocialNetWorkNewsFragment : Fragment() {

    private lateinit var socialNetWorkNewViewModel: FragmentSocialNetWorkNewsViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        socialNetWorkNewViewModel = FragmentSocialNetWorkNewsViewModel(requireActivity())
    ...
    private fun setAdapterItems() {
        socialNetWorkNewViewModel.images.observe(viewLifecycleOwner, Observer { images ->
            socialNetWorkNewViewModel.itemList.observe(viewLifecycleOwner, Observer {
