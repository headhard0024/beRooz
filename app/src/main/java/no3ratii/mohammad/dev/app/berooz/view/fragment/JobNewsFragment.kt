...
import no3ratii.mohammad.dev.app.berooz.viewmodel.FragmentJobNewsViewModel

class JobNewsFragment : Fragment() {

    private lateinit var knowledgeBaseNewViewModel: FragmentJobNewsViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        knowledgeBaseNewViewModel = FragmentJobNewsViewModel(requireActivity())
    ...
    private fun setAdapterItems() {
        knowledgeBaseNewViewModel.images.observe(viewLifecycleOwner, Observer { images ->
            knowledgeBaseNewViewModel.itemList.observe(viewLifecycleOwner, Observer {
