...
import no3ratii.mohammad.dev.app.berooz.viewmodel.FragmentInterntNewsViewModel
import no3ratii.mohammad.dev.app.berooz.viewmodel.FragmentMoblieNewsViewModel

class InternetNewsFragment : Fragment() {

    private lateinit var interntNewViewModel: FragmentInterntNewsViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        interntNewViewModel = FragmentInterntNewsViewModel(requireActivity())
    ...
    private fun setAdapterItems() {
        interntNewViewModel.images.observe(viewLifecycleOwner, Observer { images ->
            interntNewViewModel.itemList.observe(viewLifecycleOwner, Observer {
