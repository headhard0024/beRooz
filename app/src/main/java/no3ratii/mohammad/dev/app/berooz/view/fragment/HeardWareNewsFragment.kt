...
import no3ratii.mohammad.dev.app.berooz.viewmodel.FragmentRoboticNewsViewModel

class HeardWareNewsFragment : Fragment() {

    private lateinit var roboticNewViewModel: FragmentRoboticNewsViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        roboticNewViewModel = FragmentRoboticNewsViewModel(requireActivity())
    ...
    private fun setAdapterItems() {
        roboticNewViewModel.images.observe(viewLifecycleOwner, Observer { images ->
            roboticNewViewModel.itemList.observe(viewLifecycleOwner, Observer {
