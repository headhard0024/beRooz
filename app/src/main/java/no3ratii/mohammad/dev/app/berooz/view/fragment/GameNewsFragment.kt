...
import no3ratii.mohammad.dev.app.berooz.viewmodel.FragmentGameNewsViewModel

class GameNewsFragment : Fragment() {

    private lateinit var gameNewViewModel: FragmentGameNewsViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        gameNewViewModel = FragmentGameNewsViewModel(requireActivity())
    ...
    private fun setAdapterItems() {
        gameNewViewModel.images.observe(viewLifecycleOwner, Observer { images ->
            gameNewViewModel.itemList.observe(viewLifecycleOwner, Observer {
