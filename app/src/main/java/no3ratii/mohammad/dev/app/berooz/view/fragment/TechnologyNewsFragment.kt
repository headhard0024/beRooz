...
import no3ratii.mohammad.dev.app.berooz.viewmodel.FragmentTechnologyNewsViewModel

class TechnologyNewsFragment : Fragment() {

    private lateinit var technologyNewViewModel: FragmentTechnologyNewsViewModel
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        technologyNewViewModel = FragmentTechnologyNewsViewModel(requireActivity())
    ...
    private fun setAdapterItems() {
        technologyNewViewModel.images.observe(viewLifecycleOwner, Observer { images ->
            technologyNewViewModel.itemList.observe(viewLifecycleOwner, Observer {
