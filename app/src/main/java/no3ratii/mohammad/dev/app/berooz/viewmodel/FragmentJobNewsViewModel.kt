...
class FragmentJobNewsViewModel(activity: Activity) {
    ...
    private fun initialize(activity: Activity) {
        object : AReadNews() {
            override fun onSuccess(
                ...
                this@FragmentJobNewsViewModel.itemList.value = itemList
                this@FragmentJobNewsViewModel.images.value = images
            }
